...
Function Import_sgRNAs() As Boolean
    ...
    Dim Library_Path As String, sgRNA_DataLine As String, i As Long, ParsingLine() As String
    Dim Species As String, Gene_Name As String, Modulation_Mode As String, Promoter_Len As Long
    Dim Annotation_Type As String
    
    Gene_Name = Gene_Name_Conversion(Sheets("Main").Range("Targeted_Gene"))
    Modulation_Mode = UCase(Sheets("Main").Range("Modulation_Mode"))
    Promoter_Len = Sheets("Main").Range("Promoter_Length")
    ...
    If InStr(1, Species, "HUMAN") > 0 Or InStr(1, Species, "HOMO") > 0 Then
        ...
        If Modulation_Mode = "ACTIVATION" Then
            Library_Path = ActiveWorkbook.Path & "/Library/" & "hCRISPRa_Lib.txt"
            Annotation_Type = "CRISPRa"
        ElseIf Modulation_Mode = "INHIBITION" Then
            Library_Path = ActiveWorkbook.Path & "/Library/" & "hCRISPRi_Lib.txt"
            Annotation_Type = "CRISPRi"
        Else
            Call Print_Log(0, Procedure, "Modulation mode should be either Activation or Inhibition.", "Bad")
            Import_sgRNAs = False
            Exit Function
        End If
    ...
    ElseIf InStr(1, Species, "MOUSE") > 0 Or InStr(1, Species, "MUS") > 0 Then
        ...
        If Modulation_Mode = "ACTIVATION" Then
            Library_Path = ActiveWorkbook.Path & "/Library/" & "mCRISPRa_Lib.txt"
            Annotation_Type = "CRISPRa"
        ElseIf Modulation_Mode = "INHIBITION" Then
            Library_Path = ActiveWorkbook.Path & "/Library/" & "mCRISPRi_Lib.txt"
            Annotation_Type = "CRISPRi"
        Else
            Call Print_Log(0, Procedure, "Modulation mode should be either Activation or Inhibition.", "Bad")
            Import_sgRNAs = False
    ...
    While Not EOF(1)
        ...
        If InStr(1, UCase(sgRNA_DataLine), Gene_Name) > 0 Then
            ...
            End If
            Range("Annotation_Type").Offset(i, 0) = Annotation_Type
            i = i + 1
        End If
    Wend
...
Function Annotator(GenBank_File_Path As String) As Boolean
    ...
    Annotated_File_Path = ActiveWorkbook.Path & "/" & Range("Targeted_Gene") & "_" & Range("Modulation_Mode") & "_Annotated.gb"
...
Function Reference_Identifier(Species As String, Refrence_Number As Long) As String
    ...
    If UCase(Species) = "HUMAN" Then
        ...
        If Refrence_Number = 1 Then Reference_Identifier = "PMID: 30575746 _ Calabrese"
        If Refrence_Number = 2 Then Reference_Identifier = "PMID: 27661255 _ Weissman"
        If Refrence_Number = 3 Then Reference_Identifier = "PMID: 28792927 _ SAM system"
        If Refrence_Number = 4 Then Reference_Identifier = "PMID: 30477585 _ Wright"
        If Refrence_Number = 5 Then Reference_Identifier = "Girardi et al unpublished"
        If Refrence_Number = 6 Then Reference_Identifier = "PMID: 30575746 _ Dolcetto"
        If Refrence_Number = 7 Then Reference_Identifier = "PMID: 27661255 _ Weissman"
        
    ElseIf UCase(Species) = "MOUSE" Then
        
        If Refrence_Number = 1 Then Reference_Identifier = "PMID: 30575746 _ Caprano"
        If Refrence_Number = 2 Then Reference_Identifier = "PMID: 27661255 _ Weissman"
        If Refrence_Number = 3 Then Reference_Identifier = "PMID: 30349047 _ SAM v1"
        If Refrence_Number = 4 Then Reference_Identifier = "PMID: 30318302 _ Qi"
        If Refrence_Number = 5 Then Reference_Identifier = "PMID: 30575746 _ Dolomiti"
        If Refrence_Number = 6 Then Reference_Identifier = "PMID: 27661255 _ Weissman"
